    ...
    public void run(String... args) throws Exception {
        if (userRepository.count() == 0) {
            ...
            User superAdminUser = new User(null, "Kamkoum", "Sabrine", "kamkoumsabrine@gmail.com",123456,null,null, new BCryptPasswordEncoder().encode("password"),
                    null,null,null,null,null,null,null,adminRole, false, LocalDateTime.now());
         ...
         //   User etudiantUser1 = new User(null, "Amine", "Amine", "Amineamine@gmail.com",123456,null,null, new BCryptPasswordEncoder().encode("password"),null,null,null,null,null,LocalDate.of(2001, 4, 30),60545210, etudiantRole,
             ...
             User etudiantUser = new User(null, "Ahmed", "Ahmed", "ahmedahmed@gmail.com",5656565,"Informatique","1er", new BCryptPasswordEncoder().encode("password"),"mourouj","info","8888","M","mourouj", LocalDate.of(2001, 4, 30),98578525,etudiantRole,false,LocalDateTime.now());
            User etudiantUser1 = new User(null, "Amine", "Amine", "Amineamine@gmail.com",123456,"info",null, new BCryptPasswordEncoder().encode("password"),null,null,null,null,null,LocalDate.of(2001, 4, 30),98578525, etudiantRole,false,LocalDateTime.now());
