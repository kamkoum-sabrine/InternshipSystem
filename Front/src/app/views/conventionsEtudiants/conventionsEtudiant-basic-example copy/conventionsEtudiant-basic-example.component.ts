...
@Component({
  selector: 'app-conventionsEtudiantPFE-basic-example',
...
export class ConventionsEtudiantBasicExampleComponent implements OnInit {
  ...
  ngOnChanges(changes: SimpleChanges) {
    if (changes['myConventionsPFE']) {
      console.log('Nouvelle valeur de myConventionsPFE :', this.myConventionsPFE);
      this.cdr.detectChanges(); // Force la mise à jour de la vue
    }
  }
  ngOnInit() {
    console.log('Valeur reçue du parent:', this.myConventionsPFE);
