...
@Component({
  selector: 'app-entreprises-downloadable-example',
  templateUrl: './entreprises-downloadable-example.component.html',
  styleUrls: ['./entreprises-downloadable-example.component.scss'],
  standalone: true,
  imports: [ButtonDirective, SmartTableComponent]
})
export class EntreprisesDownloadableExampleComponent implements OnInit {
