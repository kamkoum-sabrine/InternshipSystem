...
@Component({
  selector: 'app-soutenances-downloadable-example',
  templateUrl: './soutenances-downloadable-example.component.html',
  styleUrls: ['./soutenances-downloadable-example.component.scss'],
  standalone: true,
  imports: [ButtonDirective, SmartTableComponent]
})
export class SoutenancesDownloadableExampleComponent implements OnInit {
