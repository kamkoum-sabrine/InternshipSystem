...
@Component({
  selector: 'app-soutenances-selectable-example',
  templateUrl: './soutenances-selectable-example.component.html',
  styleUrls: ['./soutenances-selectable-example.component.scss'],
  standalone: true,
  imports: [AlertComponent, BadgeComponent, SmartTableComponent, TemplateIdDirective, TextColorDirective]
})
export class SoutenancesSelectableExampleComponent implements OnInit {
