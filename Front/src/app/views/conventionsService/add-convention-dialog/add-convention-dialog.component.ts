...
export class AddConventionDialogComponent {
  ...
  continuerSoumission(idEntreprise: any): void {
    ...
    this.convention.ServiceId = this.utilisateur.id;

    console.log("Durée correcte (date): " + dureeStageCorrect.dateDebut);

    const formData = new FormData();
    formData.append('ServiceId', this.convention.ServiceId);
    ...
    this.gererConventionsServiceService.deposerConventionService(formData).subscribe(
      response => {
        ...
        // this.conventionsServicesService.getMesConventions(this.convention.ServiceId).subscribe(data => {
        //   this.myConventions = data;
        //   console.log(this.myConventions);
        // });
        this.dialogRef.close();
